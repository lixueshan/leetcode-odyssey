...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
|                                                              |                                                              |      |                                                              |
| [剑指 Offer II 081. 允许重复选择元素的组合](https://leetcode.cn/problems/Ygoe9J/) | [39. 组合总和](https://leetcode.cn/problems/combination-sum/) | 回溯 | 可重复选取数字的组合数。题目保证数组元素互不相同，无需预排序处理。二叉树/多叉树回溯。 |
| [剑指 Offer II 082. 含有重复元素集合的组合](https://leetcode.cn/problems/4sjJUc/) | [40. 组合总和 II](https://leetcode.cn/problems/combination-sum-ii/) | 回溯 | 每个数字只能选取一次的组合数。先排序避免出现排列不同的相同组合，另外需要跳过同层相同元素。二叉树/多叉树回溯。 |
| [剑指 Offer II 083. 没有重复元素集合的全排列](https://leetcode.cn/problems/VvJkup/) | [46. 全排列](https://leetcode.cn/problems/permutations/)     | 回溯 | 无重复元素的全排列。多叉树回溯，借助 set / 借助 visited 数组跳过已选元素。基于交换的方法。 |
| [剑指 Offer II 084. 含有重复元素集合的全排列 ](https://leetcode.cn/problems/7p8L0Z/) | [47. 全排列 II](https://leetcode.cn/problems/permutations-ii/) | 回溯 | 包含重复元素的全排列。排序预处理，同层剪枝和非同层剪枝。     |
|                                                              |                                                              |      |                                                              |
|                                                              |                                                              |      |                                                              |
|                                                              |                                                              |      |                                                              |
